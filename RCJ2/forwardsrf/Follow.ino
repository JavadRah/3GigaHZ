...
void follow(void)
{
  ...
  refreshs();
  biggestt();
     if (((srfR+srfL)>100) && srfB>100 && srfL<55 && (big_sensor_num==0 ||big_sensor_num==1 || big_sensor_num==15) && big_sensor>750)
    {
//        reduction=1;  
        MOTOR(1023+90,1023+90,-1023+90,-1023+90);
    }
    else if (((srfR+srfL)>100) && srfB>100 && srfR<55 && (big_sensor_num==0 ||big_sensor_num==1 || big_sensor_num==15) && big_sensor>750)
    {
//        reduction=1;
        MOTOR(1023-90,1023-90,-1023-90,-1023-90);
    }
